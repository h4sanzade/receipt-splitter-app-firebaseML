package com.hasanzade.germanstyle.ui.theme
...
val md_theme_dark_tertiary = Color(0xFFFFCC02)
...
// Custom gradient colors for enhanced design
val gradientStart = Color(0xFF1565C0)
val gradientEnd = Color(0xFF00695C)
